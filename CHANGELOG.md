...
* Raised the minimum supported Jahia version to 8.2.2.0, which also raises the minimum Java version to 11.

  If you run Jahia 8.1.x, 8.2.0.x or 8.2.1.0, upgrade Jahia to 8.2.2.0 or later first. Then install this version of the module, and check that it reports the started state. If you already run Jahia 8.2.2.0 or later, install it as usual.
