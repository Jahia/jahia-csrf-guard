 ...
 * ==========================================================================================
 */
package org.jahia.modules.jahiacsrfguard.servlet;
...
/**
 * Forked version of original OWASP to include a client cached version of the JS file.
 *
 * @author Jerome Blanchard
 */
public class JavaScriptServletCached extends HttpServlet {
    ...
    static {
        ...
        JS_REPLACEMENT_MAP.put(DOMAIN_ORIGIN_IDENTIFIER, (csrfGuard, request) -> ObjectUtils.firstNonNull(
                ...
                StringUtils.defaultString(JavaScriptServletCached.parseDomain(request.getRequestURL()))));
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(JavaScriptServletCached.class);
